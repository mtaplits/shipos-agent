...
const i18n = defineMessages({
  ...
  description: {
    ...
    defaultMessage:
      'By default SHIP-OS Agent starts a local backend. Use this to connect to an external ACP-compatible backend.',
  },
  useExternalServer: {
  ...
  serverUrlHelp: {
    ...
    defaultMessage:
      'Enter the HTTP(S) base URL. SHIP-OS Agent checks /status and connects to /acp under this base.',
  },
  secretKey: {
  ...
  restartNote: {
    ...
    defaultMessage: 'Changes apply to new chat windows. Restart SHIP-OS Agent to update existing windows.',
  },
  urlProtocolError: {
