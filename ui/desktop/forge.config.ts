...
let cfg = {
  ...
  extendInfo: {
    ...
    NSMicrophoneUsageDescription:
      'SHIP-OS Agent needs access to your microphone for voice dictation.',
    NSAppleEventsUsageDescription:
      'SHIP-OS Agent needs access to send Apple Events to control other apps on your behalf.',
  },
};
  ...
  publishers: [
    {
      ...
      config: {
        repository: {
          owner: process.env.GITHUB_OWNER || 'mtaplits',
          name: process.env.GITHUB_REPO || 'shipos-agent',
        },
        prerelease: false,
        draft: true,
      },
  ...
  makers: [
    ...
    },
    {
      ...
      config: {
        ...
        bin: 'shipos-agent',
        maintainer: 'SHIP-OS',
        homepage: 'https://github.com/mtaplits/shipos-agent',
    ...
    },
    {
      ...
      config: {
        options: {
          id: 'com.shipos.agent', // NOTE: kept for backwards compat with existing installs
          categories: ['Development'],
          mimeType: ['x-scheme-handler/shipos-agent'],
          icon: {
